...
private def multiRegTabbedCss : String :=
...
private def multiRegTabbedJs : String :=
...
def multiRegTabbedPlot (xs : Array (String × Array Float)) (ys : Array Float)
...
<style>{multiRegTabbedCss}</style></head><body>

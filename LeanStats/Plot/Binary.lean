...
<div class='controls'>
  ...
  <label>Line: <select id='lineW'><option value='0.5'>━</option><option value='1'>━━</option><option value='2' selected>━━━</option><option value='3'>━━━━</option><option value='5'>━━━━━</option></select></label>

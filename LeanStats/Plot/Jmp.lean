...
<div class='plot-grid'>
  ...
  <div class='x-ctrl'>
    ...
    degree <select id='degree'><option value='0'>0</option><option value='1' selected>1</option><option value='2'>2</option><option value='3'>3</option><option value='4'>4</option></select>

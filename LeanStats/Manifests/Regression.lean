...
theorem correlation_empty_test : LeanStats.Manifests.floatBitsEq (correlation #[] #[]) 0 = true := by native_decide

TestedConjecture correlation_empty : correlation #[] #[] = 0

/-- Correlation of singleton arrays is 0 (need ≥ 2 points). -/
theorem correlation_singleton_test : LeanStats.Manifests.floatBitsEq (correlation #[1.0] #[2.0]) 0 = true := by native_decide

TestedConjecture correlation_singleton : correlation #[1.0] #[2.0] = 0

/-- Mismatched-length arrays: correlation is 0. -/
theorem correlation_mismatched_test : LeanStats.Manifests.floatBitsEq (correlation #[1.0, 2.0] #[1.0]) 0 = true := by native_decide

TestedConjecture correlation_mismatched : correlation #[1.0, 2.0] #[1.0] = 0
...
theorem correlation_perfect_test :
  LeanStats.Manifests.floatBitsEq (correlation #[1.0, 2.0, 3.0] #[1.0, 2.0, 3.0]) 1.0 = true := by native_decide

TestedConjecture correlation_perfect :
...
theorem regression_slope_test :
  LeanStats.Manifests.optionFloatBitsEq (getSlope #[1.0, 2.0, 3.0] #[3.0, 5.0, 7.0]) (some 2.0) = true := by native_decide

TestedConjecture regression_slope :
  getSlope #[1.0, 2.0, 3.0] #[3.0, 5.0, 7.0] = some 2.0

/-- Regression on y = 2x + 1 recovers intercept = 1. -/
theorem regression_intercept_test :
  LeanStats.Manifests.optionFloatBitsEq (getIntercept #[1.0, 2.0, 3.0] #[3.0, 5.0, 7.0]) (some 1.0) = true := by native_decide

TestedConjecture regression_intercept :
  getIntercept #[1.0, 2.0, 3.0] #[3.0, 5.0, 7.0] = some 1.0

/-- Perfect linear data yields R² = 1. -/
theorem regression_r2_perfect_test :
  LeanStats.Manifests.optionFloatBitsEq (getR2 #[1.0, 2.0, 3.0] #[3.0, 5.0, 7.0]) (some 1.0) = true := by native_decide

TestedConjecture regression_r2_perfect :
